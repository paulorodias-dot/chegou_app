  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      /* ======================================================
         ...
         Somente:
         CPF OU e-mail do papel Morador.

         Username não participa.
      ====================================================== */

      if (tipoAcesso === "morador") {
        const login =
          normalizarEmailOuCpf(
            emailCpf
          );
        ...
        setStatus(
          "Verificando acesso do morador..."
        );

        resultado =
          await loginComEmailSenha(
            login,
            senha
          );
      }
      ...
      if (
        ...
        setStatus(
          "Verificando acesso do funcionário..."
        );

        resultado =
          await loginFuncionarioCondominio(
            codigoNormalizado,
            usernameNormalizado,
            senha
          );
      ...
      /* ======================================================
         ...
         O React não decide autorização.
         Cada serviço já devolve o contexto autorizado.
      ====================================================== */
