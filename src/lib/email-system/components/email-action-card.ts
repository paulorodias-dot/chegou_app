...
export function renderEmailActionCard({
  ...
  description = "Use o botão abaixo para finalizar seu cadastro e ativar seu acesso.",
  buttonLabel = "Completar meu cadastro",
  illustrationAlt = "Ilustração de convite e início de cadastro.",
  ...
  const safeIllustrationUrl =
    escapeHtmlAttribute(illustrationUrl);
  ...
  const safeIllustrationAlt =
    escapeHtmlAttribute(illustrationAlt);
